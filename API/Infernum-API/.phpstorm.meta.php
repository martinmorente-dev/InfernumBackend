...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./var/www/html/Infernum-API/public/storage' => 'string',
            ...
            'l5-swagger.defaults.securityDefinitions.securitySchemes.sanctum.type' => 'string',
            'l5-swagger.defaults.securityDefinitions.securitySchemes.sanctum.scheme' => 'string',
            'l5-swagger.defaults.securityDefinitions.securitySchemes.sanctum.bearerFormat' => 'string',
            'l5-swagger.defaults.securityDefinitions.securitySchemes.sanctum.description' => 'string',
            'l5-swagger.defaults.securityDefinitions.securitySchemes.sanctum.name' => 'string',
            'l5-swagger.defaults.securityDefinitions.securitySchemes.sanctum.in' => 'string',
            'l5-swagger.defaults.securityDefinitions.security.0.sanctum' => 'array',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./var/www/html/Infernum-API/public/storage','l5-swagger.default',
...
'l5-swagger.defaults.scanOptions.open_api_spec_version','l5-swagger.defaults.securityDefinitions.securitySchemes.sanctum.type','l5-swagger.defaults.securityDefinitions.securitySchemes.sanctum.scheme','l5-swagger.defaults.securityDefinitions.securitySchemes.sanctum.bearerFormat','l5-swagger.defaults.securityDefinitions.securitySchemes.sanctum.description',
'l5-swagger.defaults.securityDefinitions.securitySchemes.sanctum.name','l5-swagger.defaults.securityDefinitions.securitySchemes.sanctum.in','l5-swagger.defaults.securityDefinitions.security.0.sanctum','l5-swagger.defaults.generate_always','l5-swagger.defaults.generate_yaml_copy',
